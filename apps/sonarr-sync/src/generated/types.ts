...
export type CreateSonarrSeriesMutationVariables = Exact<{
  sonarrSery: SonarrSeryInput;
}>;


export type CreateSonarrSeriesMutation = { __typename?: 'Mutation', createSonarrSery?: { __typename: 'CreateSonarrSeryPayload' } | null | undefined };

export type GetSonarrSeriesByIdListQueryVariables = Exact<{
  in?: InputMaybe<Array<Scalars['Int']> | Scalars['Int']>;
}>;


export type GetSonarrSeriesByIdListQuery = { __typename?: 'Query', allSonarrSeries?: { __typename?: 'SonarrSeriesConnection', edges: Array<{ __typename?: 'SonarrSeriesEdge', node?: { __typename?: 'SonarrSery', sonarrId: number, sonarrName: string, sonarrSlug: string, tvdbid: number, id: number } | null | undefined }> } | null | undefined };

export type UpdateSonarrSeriesMutationVariables = Exact<{
  id: Scalars['Int'];
  sonarrSeryPatch: SonarrSeryPatch;
}>;


export type UpdateSonarrSeriesMutation = { __typename?: 'Mutation', updateSonarrSeryById?: { __typename: 'UpdateSonarrSeryPayload' } | null | undefined };


export const CreateSonarrSeriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateSonarrSeries"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sonarrSery"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SonarrSeryInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createSonarrSery"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"sonarrSery"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sonarrSery"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]}}]} as unknown as DocumentNode<CreateSonarrSeriesMutation, CreateSonarrSeriesMutationVariables>;
export const GetSonarrSeriesByIdListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetSonarrSeriesByIdList"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"in"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"allSonarrSeries"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"sonarrId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"in"},"value":{"kind":"Variable","name":{"kind":"Name","value":"in"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"edges"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sonarrId"}},{"kind":"Field","name":{"kind":"Name","value":"sonarrName"}},{"kind":"Field","name":{"kind":"Name","value":"sonarrSlug"}},{"kind":"Field","name":{"kind":"Name","value":"tvdbid"}},{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetSonarrSeriesByIdListQuery, GetSonarrSeriesByIdListQueryVariables>;
export const UpdateSonarrSeriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateSonarrSeries"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sonarrSeryPatch"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SonarrSeryPatch"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateSonarrSeryById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"sonarrSeryPatch"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sonarrSeryPatch"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]}}]} as unknown as DocumentNode<UpdateSonarrSeriesMutation, UpdateSonarrSeriesMutationVariables>;