...
export const GetDataForDefaultItemsDocument = gql`
    query GetDataForDefaultItems($first: Int!) {
  allRssItems(orderBy: PUBLISH_DATE_DESC, first: $first) {
    edges {
      node {
        hash
        publishDate
  ...
  allDownloadConfigs {
    ...
    `;
export const GetDataForForcedItemsDocument = gql`
    query GetDataForForcedItems {
  allAnimeMetadata(condition: {forceScratch: true}) {
    edges {
      node {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetDataForDefaultItems(variables: GetDataForDefaultItemsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetDataForDefaultItemsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDataForDefaultItemsQuery>(GetDataForDefaultItemsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDataForDefaultItems', 'query');
    },
    GetDataForForcedItems(variables?: GetDataForForcedItemsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetDataForForcedItemsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDataForForcedItemsQuery>(GetDataForForcedItemsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDataForForcedItems', 'query');
    }
  };
}
