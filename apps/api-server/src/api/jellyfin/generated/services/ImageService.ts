...
export class ImageService {
   ...
   * @returns binary Splashscreen returned successfully.
   * @throws ApiError
   */
  public static getSplashscreen(
    tag?: string,
    format?: ImageFormat,
    maxWidth?: number,
    maxHeight?: number,
   ...
   * @throws ApiError
   */
  public static uploadCustomSplashscreen(
    requestBody?: Blob,
   ...
   * @throws ApiError
   */
  public static deleteCustomSplashscreen(): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/Branding/Splashscreen',
      errors: {
